...
type SalesChartProps<PropT> = {
  bookings: Array<PropT>;
  numDays: number;
};
...
>({ bookings, numDays }: SalesChartProps<T>) {
  ...
  return (
    <StyledSalesChart>
      <Heading as="h2">
        Sales from {format(allDates[0], "MMM dd yyy")} &mdash;{" "}
        {format(allDates[allDates.length - 1], "MMM dd yyy")}
      </Heading>
